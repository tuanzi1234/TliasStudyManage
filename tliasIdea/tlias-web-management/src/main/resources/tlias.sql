...
/*!40000 ALTER TABLE `clazz`
    DISABLE KEYS */;
INSERT INTO `clazz` (`id`, `name`, `room`, `begin_date`, `end_date`, `master_id`, `subject`, `create_time`,
                     `update_time`)
VALUES (1, 'JavaEE就业163期', '212', '2023-04-30', '2023-06-29', 10, 1, '2023-06-01 17:08:23', '2023-06-01 17:39:58'),
       ...
       (9, 'JavaEE就业168期', '215', '2024-08-20', '2025-01-01', 47, 1, '2024-08-17 22:54:09', '2024-08-19 14:36:28'),
       (11, 'JavaEE就业169期', '213', '2024-08-01', '2025-01-10', 27, 1, '2024-08-20 09:51:45', '2024-08-20 09:52:23'),
       (12, 'JavaEE就业422', '214', '2024-08-21', '2025-01-10', 47, 1, '2024-08-21 15:07:20', '2024-08-21 15:07:20');
/*!40000 ALTER TABLE `clazz`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `emp`
    DISABLE KEYS */;
INSERT INTO `emp` (`id`, `username`, `password`, `name`, `gender`, `phone`, `job`, `salary`, `image`, `entry_date`,
                   `dept_id`, `create_time`, `update_time`)
VALUES (1, 'shinaian', '123456', '施耐庵', 1, '13309090001', 4, NULL,
       ...
       (28, 'lizhong', '123456', '李忠', 1, '13309090028', 5, 5000,
        ...
        '2023-11-17 16:34:22'),
       (30, 'liyun', '123456', '李云', 1, '13309090030', 1, 2800,
        'https://java422-web-ai.oss-cn-beijing.aliyuncs.com/2024/08/32a82999-f0b3-4c2c-9480-f668a3ce7ae8.png',
        '2020-03-01', 32, '2023-10-20 16:35:33', '2024-08-28 21:26:16'),
       (47, 'gaoyuanyuan6', '1234567', '高圆圆6', 2, '13309090089', 6, 10000,
        'https://java422-web-ai.oss-cn-beijing.aliyuncs.com/2024/08/0f740b17-84c6-416b-98ad-6bf9d462ab48.png',
        '2024-08-19', 16, '2024-08-17 16:46:13', '2024-08-28 21:26:12');
/*!40000 ALTER TABLE `emp`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 50
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='工作经历';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `emp_expr`
    DISABLE KEYS */;
INSERT INTO `emp_expr` (`id`, `emp_id`, `begin`, `end`, `company`, `job`)
VALUES (46, 47, '2024-08-01', '2024-08-03', '百度', 'java开发'),
       (47, 47, '2024-08-05', '2024-08-10', '字节跳动', '架构师'),
       (48, 47, '2024-07-01', '2024-07-31', '黑马', '程序员鼓励师'),
       (49, 30, '2024-08-02', '2024-08-17', '111', '222');
/*!40000 ALTER TABLE `emp_expr`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='员工日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `emp_login_log`
    DISABLE KEYS */;
INSERT INTO `emp_login_log` (`id`, `username`, `password`, `login_time`, `is_success`, `jwt`, `cost_time`)
VALUES (1, 'songjiang', '123456', '2024-08-26 08:37:38', 1,
        'eyJhbGciOiJIUzI1NiJ9.eyJpZCI6MiwidXNlcm5hbWUiOiJzb25namlhbmciLCJleHAiOjE3MjQ2NzU4NTl9.957hnUiENe0Tih-s_JRsx-G3HPZ2O7fxtOfxOIm01RE',
        745),
       (2, 'songjiang', '123', '2024-08-26 08:48:17', 0, NULL, 4753),
       (3, 'songjiang', '1235', '2024-08-26 08:49:37', 0, NULL, 6606),
       (4, 'songjiang', '123456', '2024-08-26 08:50:29', 1,
        'eyJhbGciOiJIUzI1NiJ9.eyJpZCI6MiwidXNlcm5hbWUiOiJzb25namlhbmciLCJleHAiOjE3MjQ2NzY2Mjh9.DQSsAw8OcwWwjoYYpGZohxUNgqtd9pMn9wu-8leFQ6I',
        43),
       (5, 'likui', '123456', '2024-08-26 16:40:11', 1,
        'eyJhbGciOiJIUzI1NiJ9.eyJpZCI6OCwidXNlcm5hbWUiOiJsaWt1aSIsImV4cCI6MTcyNDcwNDgxMX0.NOjsCFeiEisXuwGecCyyc95WCWPP6zwKH3dgU3mloh4',
        15),
       (6, 'songjiang', '123456', '2024-08-27 08:18:51', 1,
        'eyJhbGciOiJIUzI1NiJ9.eyJpZCI6MiwidXNlcm5hbWUiOiJzb25namlhbmciLCJleHAiOjE3MjQ3NjExMzJ9.ty0HmpMB_Dh5Bh48WJ5HsD8ghrSG9Z_chidGwh0F1gk',
        991);
/*!40000 ALTER TABLE `emp_login_log`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `operate_log`
    DISABLE KEYS */;
INSERT INTO `operate_log` (`id`, `operate_emp_id`, `operate_time`, `class_name`, `method_name`, `method_params`,
                           `return_value`, `cost_time`)
VALUES (1, 1, '2024-08-24 15:33:04', 'com.itheima.controller.DeptController', 'delete', '[20]',
        'Result(code=1, msg=success, data=null)', 41278),
       (2, 1, '2024-08-24 15:32:22', 'com.itheima.controller.DeptController', 'delete', '[20]',
        'Result(code=1, msg=success, data=null)', 10046),
       (3, 1, '2024-08-24 15:33:37', 'com.itheima.controller.DeptController', 'add',
        '[Dept(id=null, name=456, createTime=2024-08-24T15:33:37.472459700, updateTime=2024-08-24T15:33:37.472459700)]',
        'Result(code=1, msg=success, data=null)', 2596),
       (4, 1, '2024-08-24 15:33:43', 'com.itheima.controller.DeptController', 'update',
        '[Dept(id=21, name=45678, createTime=2024-08-24T15:33:37, updateTime=2024-08-24T15:33:43.221725500)]',
        'Result(code=1, msg=success, data=null)', 5),
       (5, 1, '2024-08-24 15:33:45', 'com.itheima.controller.DeptController', 'delete', '[21]',
        'Result(code=1, msg=success, data=null)', 10),
       (6, 1, '2024-08-24 16:30:45', 'com.itheima.controller.DeptController', 'update',
        '[Dept(id=22, name=1234567, createTime=2024-08-24T16:26:59, updateTime=2024-08-24T16:30:45.168029900)]',
        'Result(code=1, msg=success, data=null)', 12),
       (7, 1, '2024-08-24 16:30:48', 'com.itheima.controller.DeptController', 'delete', '[22]',
        'Result(code=1, msg=success, data=null)', 8),
       (8, 1, '2024-08-24 16:30:50', 'com.itheima.controller.DeptController', 'add',
        '[Dept(id=null, name=111, createTime=2024-08-24T16:30:50.269770700, updateTime=2024-08-24T16:30:50.269770700)]',
        'Result(code=1, msg=success, data=null)', 4),
       (9, 1, '2024-08-24 16:30:52', 'com.itheima.controller.DeptController', 'delete', '[23]',
        'Result(code=1, msg=success, data=null)', 7),
       (10, 1, '2024-08-24 16:47:03', 'com.itheima.controller.DeptController', 'add',
        '[Dept(id=null, name=财务2部, createTime=2024-08-24T16:47:03.299816200, updateTime=2024-08-24T16:47:03.299816200)]',
        'Result(code=1, msg=success, data=null)', 4),
       (11, 1, '2024-08-24 16:47:14', 'com.itheima.controller.DeptController', 'delete', '[24]',
        'Result(code=1, msg=success, data=null)', 5),
       (12, 1, '2024-08-24 16:54:35', 'com.itheima.controller.DeptController', 'update',
        '[Dept(id=1, name=学工部, createTime=2023-09-25T09:47:40, updateTime=2024-08-24T16:54:34.890667500)]',
        'Result(code=1, msg=success, data=null)', 523),
       (13, 2, '2024-08-24 17:20:23', 'com.itheima.controller.DeptController', 'add',
        '[Dept(id=null, name=123, createTime=2024-08-24T17:19:56.070887200, updateTime=2024-08-24T17:19:56.070887200)]',
        'Result(code=1, msg=success, data=null)', 40),
       (14, 8, '2024-08-24 17:21:12', 'com.itheima.controller.DeptController', 'delete', '[25]',
        'Result(code=1, msg=success, data=null)', 6),
       (15, 8, '2024-08-25 19:54:33', 'com.itheima.controller.DeptController', 'update',
        '[Dept(id=31, name=研发部, createTime=2024-08-25T16:36:01, updateTime=2024-08-25T19:54:33.478193)]',
        'Result(code=1, msg=success, data=null)', 6),
       (16, 8, '2024-08-25 19:54:40', 'com.itheima.controller.DeptController', 'update',
        '[Dept(id=29, name=后勤部, createTime=2024-08-25T16:34:37, updateTime=2024-08-25T19:54:40.151405900)]',
        'Result(code=1, msg=success, data=null)', 4),
       (17, 8, '2024-08-25 19:54:46', 'com.itheima.controller.DeptController', 'delete', '[26]',
        'Result(code=1, msg=success, data=null)', 5),
       (18, 2, '2024-08-26 16:38:57', 'com.itheima.controller.EmpController', 'update',
        '[Emp(id=30, username=liyun, password=null, name=李云, gender=1, phone=13309090030, job=1, salary=2800, image=https://java422-web-ai.oss-cn-beijing.aliyuncs.com/2024/08/c0054a00-b8be-4006-81ff-71286de48cc7.JPG, entryDate=2020-03-01, deptId=16, createTime=2023-10-20T16:35:33, updateTime=2024-08-26T16:38:57.138751200, deptName=null, exprList=[])]',
        'Result(code=1, msg=success, data=null)', 45),
       (19, 8, '2024-08-26 16:41:25', 'com.itheima.controller.EmpController', 'save',
        '[Emp(id=52, username=dengdengdengdcneg, password=, name=老邓, gender=2, phone=18888888888, job=1, salary=2, image=https://java422-web-ai.oss-cn-beijing.aliyuncs.com/2024/08/f6cee736-c316-4f50-b40d-6f9043b193a7.png, entryDate=2024-08-26, deptId=3, createTime=2024-08-26T16:41:25.238940900, updateTime=2024-08-26T16:41:25.239940300, deptName=null, exprList=[EmpExpr(id=null, empId=52, begin=2024-08-24, end=2024-08-25, company=白马, job=驮唐僧)])]',
        'Result(code=1, msg=success, data=null)', 12);
/*!40000 ALTER TABLE `operate_log`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `student`
    DISABLE KEYS */;
INSERT INTO `student` (`id`, `name`, `no`, `gender`, `phone`, `id_card`, `is_college`, `address`, `degree`,
                       `graduation_date`, `clazz_id`, `violation_count`, `violation_score`, `create_time`,
                       `update_time`)
VALUES (1, '段誉', '2022000001', 1, '18800000001', '110120000300200001', 1, '北京市昌平区建材城西路1号', 1,
       ...
       (13, '耶律洪基', '2022000013', 1, '18800008901', '110120000300200013', 1, '北京市昌平区建材城西路13号', 4,
        '2023-07-01', 11, 0, 0, '2023-11-14 21:22:19', '2024-08-20 09:52:09'),
       ...
       (37, '段誉', '2024062801', 1, '15800000001', '510120000300200001', 1, '北京市昌平区建材城西路1号', 4,
        '2021-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (38, '萧峰', '2024062802', 1, '15800210002', '510120000300200002', 0, '北京市昌平区建材城西路2号', 4,
        '2022-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (39, '虚竹', '2024062803', 1, '15800210003', '510120000300200003', 0, '北京市昌平区建材城西路3号', 4,
        '2023-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (40, '萧远山', '2024062804', 1, '15800350004', '510120000300200004', 0, '北京市昌平区建材城西路4号', 4,
        '2024-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (41, '阿朱', '2024062805', 2, '15800455005', '510120000300200005', 0, '北京市昌平区建材城西路5号', 3,
        '2020-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (42, '阿紫', '2024062806', 2, '15800560006', '510120000300200006', 0, '北京市昌平区建材城西路6号', 4,
        '2021-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (43, '游坦之', '2024062807', 1, '15800665007', '510120000300200007', 0, '北京市昌平区建材城西路7号', 4,
        '2022-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (44, '康敏', '2024062808', 2, '15800770008', '510120000300200008', 0, '北京市昌平区建材城西路8号', 4,
        '2023-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (45, '徐长老', '2024062809', 1, '15800875009', '510120000300200009', 0, '北京市昌平区建材城西路9号', 4,
        '2024-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (46, '云中鹤', '2024062810', 1, '15800980010', '510120000300200010', 1, '北京市昌平区建材城西路10号', 5,
        '2020-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (47, '钟万仇', '2024062811', 1, '15801085011', '510120000300200011', 0, '北京市昌平区建材城西路11号', 6,
        '2021-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (48, '崔百泉', '2024062812', 1, '15801190012', '510120000300200012', 0, '北京市昌平区建材城西路12号', 3,
        '2022-07-05', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (49, '耶律洪基', '2024062813', 1, '15801295013', '510120000300200013', 0, '北京市昌平区建材城西路13号', 4,
        '2023-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (50, '天山童姥', '2024062814', 2, '15801400014', '510120000300200014', 0, '北京市昌平区建材城西路14号', 4,
        '2024-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (51, '刘竹庄', '2024062815', 1, '15801505015', '510120000300200015', 0, '北京市昌平区建材城西路15号', 4,
        '2020-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (52, '李春来', '2024062816', 1, '15801610016', '510120000300200016', 0, '北京市昌平区建材城西路16号', 3,
        '2021-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (53, '王语嫣', '2024062817', 2, '15801715017', '510120000300200017', 1, '北京市昌平区建材城西路17号', 4,
        '2022-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01'),
       (54, '郑成功', '2024062818', 1, '15801820018', '510120000300200018', 0, '北京市昌平区回龙观街道88号', 4,
        '2021-07-01', 12, 0, 0, '2024-08-21 15:13:01', '2024-08-21 15:13:01');
/*!40000 ALTER TABLE `student`
    ENABLE KEYS */;
UNLOCK TABLES;
